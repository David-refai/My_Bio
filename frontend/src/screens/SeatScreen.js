import { setSeats } from "../localStorage";
  ...
  after_render: () => {
    document
      ...
      .addEventListener('submit', async (e) => {
        e.preventDefault();
        const seatsMethod = document.querySelector(
          'input[type="checkbox"]:checked'
        ).value;
        setSeats({ seatsMethod });
        document.location.hash = '/signin';
      });
    
      document.getElementById('btn-colc').addEventListener('click', () => {
            document.location.hash = '/signin';
        });
  },
  render: () => {
...
<!-- 
  <div>
    ...
    <input type='text' min='1' size='10' class='value' value='0' />
  ...
  <div class="inputForm">
    ...
    Number of Seats: <input type="number" min="0" id="Numseats" required>
    <div id="msg">
      <pre></pre>
    </div>
  ...
  <div class="displayerBoxes">
    ...
    <table class="Displaytable">
      ...
      <!-- <p class="text"> -->
        ...
        <br /><button id="btn-colc" onclick="clickForBooking()">Confirm Selection</button>
